...
* **real**: The real experiments with testQAOASolver.
  
* **design**: a drawio files where the design of the workflows is done. Some PDFs with this designs are rendered.